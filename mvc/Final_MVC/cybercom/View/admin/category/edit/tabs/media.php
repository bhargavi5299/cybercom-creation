<form id="mediaForm" action="<?php echo $this->getUrl()->getUrl('update', 'category_media'); ?>" enctype="multipart/form-data"  method="post">
    <div class="float-right mb-2 mr-2">
        ...
        <button type="button" onclick="object.resetParams().setForm('#mediaForm').setUrl('<?php echo $this->getUrl()->getUrl('delete', 'category_media'); ?>').load()" class="btn btn-danger text-left mt-3 mb-2">Remove</button>
    </div><br>
...
<script>
    $(document).ready(function(){
        $("#btn_upload").click(function(){
            object.setUrl('<?php echo $this->getUrl()->getUrl("upload", "category_media"); ?>');
            var fd = new FormData();
