...
<div class="row">
    ...
    <div class="col-md-10">
        <form action="" method="POST" class="addressGrid" enctype="multipart/form-data" novalidate>
                        ...
                        <td>
                            <table border="1" height="500px" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a onclick="object.setForm('.addressGrid').setUrl('<?php echo $this->getUrl()->getUrl('saveBilling', 'cart_checkOut') ?>').load()" class="btn btn-warning" href="javascript:void(0)">Save</a>
                                        </td>
                                        <td>
                        ...
                        <td>
                            <table border="1" height="500px" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a onclick="object.setForm('.addressGrid').setUrl('<?php echo $this->getUrl()->getUrl('saveShipping', 'cart_checkOut') ?>').load()" class="btn btn-warning" href="javascript:void(0)">Save</a>
                                        </td>
                                        <td>
                        ...
                        <td>
                            <table border="1" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <a onclick="object.setForm('.addressGrid').setUrl('<?php echo $this->getUrl()->getUrl('savePaymentMethod', 'admin_cart_checkOut') ?>').load()" class="btn btn-warning" href="javascript:void(0)">Save</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <td>
                            <table border="1" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <a onclick="object.setForm('.addressGrid').setUrl('<?php echo $this->getUrl()->getUrl('saveShippingMethod', 'cart_checkOut') ?>').load()" class="btn btn-warning" href="javascript:void(0)">Save</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
