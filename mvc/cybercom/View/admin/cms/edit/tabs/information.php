...
<div class="form-row">
    ...
    <div class="col-lg-4 mt-3">
        <?php if($this->getRequest()->getGet('id')) :?>
            <button type="submit" onclick="getContent()" class="btn btn-lg btn-success">Update</button>
        <?php else: ?>
            <button type="submit" onclick="getContent()" class="btn btn-lg btn-success">Add</button>
        <?php endif; ?>
